  ...
  <div class="page-content">
   <div class="page-bar">
    <div class="page-title-breadcrumb">
     <div class=" pull-left">
      <div class="page-title">Add OTB</div>
     </div>
     <ol class="breadcrumb page-breadcrumb pull-right">
                      ...
                      <a class="parent-item"
                          href="<?php echo site_url();?>visa/view_visa">OTB</a>&nbsp;<i class="fa fa-angle-right"></i>
                      </li>
                      <li class="active">Add OTB</li>
                  </ol>
      </div>
     </div>
     <div class="row">
 ...
 <form action="<?php echo site_url();?>visa/addVisaDetails" method="post" encrypt="multipart/form-data">
         ...
         <table id="faqs" class="table table-hover">
          ...
          <tbody>
           <tbody>
            <tr id="myTableRow">
         <td><input type="text" readonly placeholder="0" class="form-control" name="visa_category" value="OTB">
         </td>
