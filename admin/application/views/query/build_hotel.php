...
<tr>
   ...
   <td>
    ...
    <td>
      ...
      <input class="form-control child_per_room_wo_bed" type="hidden" readonly value="${no_child_room_wo_new[room_no - 1] != null ? no_child_room_wo_new[room_no - 1] : '' }" name="child_per_room_wo_bed[]" id="child_per_room_wo_bed">
      </td>
