...
.travelerboxHotel {
   ...
   <?php } ?>
   <?php  if($this->session->flashdata('successPackage'))
   {?><center>
   ...
   <?php } ?>
              ...
              <label><input type="radio" name="colorRadio" value="Excursion">Excursion</label> 
              <label><input type="radio" name="colorRadio" value="Visa"> Visa</label> 
              <label><input type="radio" name="colorRadio" value="Meals">Meals</label> 
              ...
              <!-- <a href=""><button class="first-btn">Miscellaneous</button></a> -->
               ...
               <div class="col">
                   <label class="input">
                    <input class="input__field fname all-width" type="date"
                    placeholder=" " id="specificDate1" name="specificDate" autocomplete="off"  required/>
                    <span class="input__label">Check IN<span
                   ...
                   <div class="col">
                  <label class="input">
                   <input class="input__field fname all-width" type="number" min="1"
                   placeholder=" " id="goingFrom1" name="night" required autocomplete="off" />
...
<label class="input">
 <input class="input__field  all-width" type="date"
 placeholder=" " id="endDate1" name="noDaysFrom" autocomplete="off" />
 <span class="input__label">Check Out<span
 class="colorRed">*</span></span>
...
<span id="spanSpecificDate" class="spanCompany"></span>
               ...
               <div class="row mt-4 mr-3 ml-3">
                <div class="col">
                  <label class="input">
                   <input class="input__field fname all-width" type="text"
                   placeholder=" " name="country[]" value="United Arab Emirates" required autocomplete="off" />
...
<?php $i++; } ?>
                  ...
                  <div class="d-flex  justify-content-end mt-4 mb-4" style="margin-bottom:50px !important;margin-top:50px !important">
                   ...
                   <a href="<?php echo site_url();?>query/buildPackage/<?php echo $b2bDetails->query_id;?>">
                    ...
                    <button type="button" id="disabled-btn"
                    class="new_btn px-5 mr-2">Build Quick <?php echo $buildpackage->type ?></button>
                   </a>
...
class="new_btn px-5 mr-2">Build Quick <?php echo $buildpackage->type ?></button>
                    ...
                    <?php } 
                    else if($buildpackage->type =='Meals'){?>
