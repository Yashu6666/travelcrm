...
?>
              ...
              <tbody>
                  ...
                  <td>
                      <select class="form-control bnights get_no_nights" id="buildNoNights_<?php echo $key ?>"  name="buildNoNightss[]" required="">
          ...
          <div class="mt-5">
           ...
           <td><input id="excursion_adult_SIC" type="text" placeholder="0" class="form-control" name="adult" value="<?php echo $view->Packagetravelers;?>" >
           </td>
           <td><input id="excursion_child_SIC" type="text" placeholder="0" class="form-control" name="child" value="<?php echo $buildpackage->child;?>" >
           </td>
           <td><input id="excursion_infant_SIC" type="text" placeholder="0" class="form-control" name="infant" value="<?php echo $buildpackage->infant;?>" >  
           </td>
         ...
         <tbody>
           ...
           <td><input id="excursion_adult_PVT" type="text" placeholder="0" class="form-control" name="adult" value="<?php echo $view->Packagetravelers;?>" >
           </td>
           <td><input id="excursion_child_PVT" type="text" placeholder="0" class="form-control" name="child" value="<?php echo $buildpackage->child;?>" >
           </td>
           <td><input id="excursion_infant_PVT" type="text" placeholder="0" class="form-control" name="infant" value="<?php echo $buildpackage->infant;?>" >   
           </td>
         ...
         <tbody>
           ...
           <td><input id="excursion_adult_TKT" type="text" placeholder="0" class="form-control" name="adult" value="<?php echo $view->Packagetravelers;?>" >
           </td>
           <td><input id="excursion_child_TKT" type="text" placeholder="0" class="form-control" name="child" value="<?php echo $buildpackage->child;?>" >
           </td>
           <td><input id="excursion_infant_TKT" type="text" placeholder="0" class="form-control" name="infant" value="<?php echo $buildpackage->infant;?>" >  
           </td>
       ...
       <?php if(!empty($meals)) : ?>
                          ...
                          <?php foreach(explode(",",$meals->date) as $key => $val) : ?>
                                <tr id="meals_tr<?php echo $key ?>" >
                                  <td><input class="form-control ex_meals_date" min="<?php echo date("Y-m-d") ?>" type="date" value="<?php echo explode(",",$meals->date)[$key] ?>" min="<?php echo $view->specificDate; ?>" max="<?php echo date('Y-m-d', strtotime($view->specificDate . ' + ' . (($buildpackage->night) - (1)) . ' days')); ?>" name="ex_meals_date[]" id="ex_meals_date"></td>
                                  <td>
                                    <div>
                                      <select data-mdl-for="sample2" class="form-control ex_res_type" value="" tabIndex="-1" id="ex_res_type" name="ex_res_type[]" onchange="get_resturant_name('ex_res_type','');">
                                        <option <?php echo explode(",",$meals->resturant_type)[$key] == "Standard" ? "selected" : "" ?> value="Standard">Standard</option>
                                        <option <?php echo explode(",",$meals->resturant_type)[$key] == "Premium" ? "selected" : "" ?> value="Premium">Premium</option>
                                      </select>
                                    </div>
                                  </td>
                                  <td>
                                    <select data-mdl-for="sample2" class="form-control ex_res_name" value="" tabIndex="-1" name="ex_res_name[]" id="ex_res_name">
                                      <option value="<?php echo explode(",",$meals->resturant_name)[$key]?>" ><?php echo explode(",",$meals->resturant_name)[$key]?></option>
                                    </select>
                                  <td>
                                    <div>
                                      <select data-mdl-for="sample2" class="form-control ex_meal" value="" tabIndex="-1" id="ex_meal_cal" name="ex_meal[]">
                                      <option <?php echo explode(",",$meals->meal)[$key] == "Dinner" ? "selected" : "" ?>  value="Dinner">Dinner</option>
                                        <option <?php echo explode(",",$meals->meal)[$key] == "Lunch" ? "selected" : "" ?> value="Lunch">Lunch</option>
                                      </select>
                                    </div>
                                  </td>
                                  <td>
                                    <div>
                                      ...
                                      <option <?php echo explode(",",$meals->meal_type)[$key] == "Veg" ? "selected" : "" ?> value="Veg">Veg</option>
                                        <option <?php echo explode(",",$meals->meal_type)[$key] == "Non-Veg" ? "selected" : "" ?> value="Non-Veg">Non-Veg</option>
                                        <option <?php echo explode(",",$meals->meal_type)[$key] == "Jain" ? "selected" : "" ?> value="Jain">Jain</option>
                                      </select>
                                    </div>
                                  </td>
                                  <td><input type="number" min="1" id="ex_no_of_meals" class="form-control  ex_no_of_meals" value="<?php echo explode(",",$meals->no_of_meals)[$key]?>" name="ex_no_of_meals[]">
                                  <td><input type="text" value="<?php echo $view->Packagetravelers; ?>" placeholder="0" id="adult_meal_cal" class="form-control check-adult ex_meal_adult" name="ex_meal_adult[]">
                                  </td>
                                  <td><input type="text" value="<?php echo $buildpackage->child; ?>" placeholder="0" id="child_meal_cal" class="form-control check-child ex_meal_child" name="ex_meal_child[]" <?php if ($buildpackage->child == 0) echo "disabled"; ?>>
                                  </td>

                                  <?php if(!$key > 0) : ?>
                                    <td><a class="new_btn px-3 ml-0" onclick="ex_addrowss()"> add</a></td>
                                    <?php else : ?>
                                    <td><button class="btn btn-danger btn-xs" onClick="removeID(meals_tr<?php echo $key ?>)"><i class="fa fa-trash"></i></button> </td>
                                  <?php endif ?>  
        ...
        <tr id="myTableRow">
          ...
          <td>
            <div>
              ...
              <option <?php echo explode(",",$meal_query[0]->meal)[$key] == "Breakfast" ? "selected" : "" ?> value="Breakfast">Breakfast</option>
          ...
          <td>
            <div>
              ...
              <option <?php echo explode(",",$meal_query[0]->meal_type)[$key] == "Veg & Non-Veg" ? "selected" : "" ?> value="Veg & Non-Veg">Veg & Non-Veg</option>
                  ...
                  <tr id="mealInternalTransfer">
                    ...
                    <td>
                      <select id="pickup_internal_meal" required name="pickup_internal_meal[]" class="pickup_internal_meal js-example-basic-multiple w-100 bg-white form-control form-control-lg">
                        <option value="<?php echo (explode(",", $internal_query1[0]->pickup)[$key]); ?>"><?php echo (explode(",", $internal_query1[0]->pickup)[$key]); ?></option>
                      </select>
                    </td>
                    <td>
                      <select id="dropoff_internal_meal" name="dropoff_internal_meal[]" class="dropoff_internal_meal js-example-basic-multiple w-100 bg-white form-control form-control-lg">
                        <option value="<?php echo (explode(",", $internal_query1[0]->dropoff)[$key]); ?>"><?php echo (explode(",", $internal_query1[0]->dropoff)[$key]); ?></option>
                      </select>
                    </td>
                    <td>
                      <input id="route_name_internal_meal" value="<?php echo (explode(",", $internal_query1[0]->transfer_route)[$key]); ?>" name="route_name_internal_meal[]" class="form-control route_name_internal_meal" type="text" placeholder="Route Name">
                    </td>
                  </tr>
                <?php endforeach; ?>
              <?php endif ?>
                  ...
                  <tr id="mealReturnTransfer">
                    ...
                    <td>
                      <select id="pickup_return_meal" required name="pickup_return_meal[]" class="pickup_return_meal js-example-basic-multiple w-100 bg-white form-control form-control-lg">
                        <option value="<?php echo (explode(",", $return_query1[0]->pickup)[$key]); ?>"><?php echo (explode(",", $return_query1[0]->pickup)[$key]); ?></option>
                      </select>
                    </td>
                    <td>
                      <select id="dropoff_return_meal" name="dropoff_return_meal[]" class="dropoff_return_meal js-example-basic-multiple w-100 bg-white form-control form-control-lg">
                        <option value="<?php echo (explode(",", $return_query1[0]->dropoff)[$key]); ?>"><?php echo (explode(",", $return_query1[0]->dropoff)[$key]); ?></option>
                      </select>
                    </td>
                    <td><input id="route_name_return_meal" value="<?php echo (explode(",", $return_query1[0]->transfer_route)[$key]); ?>" class="form-control route_name_return_meal" type="text" placeholder="Route Name" name="route_name_return_meal[]"></td>
                  </tr>
                      ...
                      $(".card-box").click(function(e) {
                          e.stopPropagation();
                            ...
                            var sub_total_adult = parseInt(sub_total_adult_single) +
                              ...
                              ((parseInt(total_pax_otb_price_adult != null ? total_pax_otb_price_adult : 0 ) / pax_adult_count) * single_share_adult_count) +
                            ...
                            var sub_total_adult_double = parseInt(hotel_rate_adult_double) +
                              ...
                              ((parseInt(total_pax_otb_price_adult != null ? total_pax_otb_price_adult : 0 ) / pax_adult_count) * double_share_adult_count) +
                            ...
                            var sub_total_adult_triple = parseInt(hotel_rate_adult_triple) +
                              ...
                              ((parseInt(total_pax_otb_price_adult != null ? total_pax_otb_price_adult : 0 ) / pax_adult_count) * triple_share_adult_count) +
                            ...
                            var sub_total_infant = parseInt(total_pax_visa_price_infant) + parseInt(total_pax_otb_price_infant != null ? total_pax_otb_price_infant : 0 ) +
                        ...
                        function removeID(id){
                          console.log("🚩 ~ file: build_excursion_edit.php ~ line 280 ~ removeID ~ id", id)
                          id.remove();
                        }
              ...
              <table class="table table-bordered" style="font-size:16px;">
                ...
                <tr class="text-center">
                  ...
                  <td> <input type="text" class="text-center w-50" name="perpax_infants" id="perpax_infants" value="0"></td>
                              ...
                              <input type="hidden" id="perpax_cnb_input" name="perpax_cnb_input" value="" />
...
function saveTransferDefault(){
  ...
  function transfer_cal(){
    ...
    transfer_cal();
    console.log("🚩 ~ file: build_package.php ~ line 2632 ~ data", data)
