       ...
       <div class="card-body ">
        ...
        <div class="mt-5">
           ...
           <div class="row mt-5 mr-3 ml-3 mb-3">
            <div>
              ...
              <tbody>
               <tr>
                <td>
                  ...
                  <select class="form-control"  required="" name="buildHotelCity" id="buildHotelCity" onchange="get_hotel_name('buildHotelCity','');">
             ...
             <div>
              ...
              value=""  id="Category" tabIndex="-1" name="Category"  onchange="get_hotel_name('Category','');">
              ...
              <td>
                ...
                <select class="form-control" id="buildHotelName"  required="" name="buildHotelName" onchange="get_route_name('buildHotelName','');" required>
                      <option>Select</option>                                             
                  </select>
              </td>
              <td>
              ...
              <td>
                ...
                <!-- <select class="form-control" id="buildExtraBedType"  required="" name="buildExtraBedType" required> -->
                  ...
                  <input type="checkbox" id="extra_with_adult" name="extra_check" value="extra_with_adult" class="check-extra"><label for="html" style="margin-left: 5%;"> Extra Bed(Adult)</label><br/>
                  <input type="checkbox" id="extra_with_child" name="extra_check" value="extra_with_child" class="check-extra"><label for="html" style="margin-left: 5%;"> Extra Bed(Child)</label><br/>
                  <input type="checkbox" id="extra_without_bed" name="extra_check" value="extra_without_bed" class="check-extra"><label for="html" style="margin-left: 5%;"> Extra W/O Bed</label>
          ...
          <div class="mt-5">
           ...
           <td><button type="button" onclick="getvisaprice()" class="btn btn-primary">Save</button>
                </td>
         </tr>
            ...
            <tbody>
             <tbody>
              ...
              <td>
               <div>
                <select required multiple="" id="excursion_name_SIC"  name="excursion[]"  class="js-example-basic-multiple w-100 bg-white form-control form-control-lg" >
           ...
           <td><button type="button" onclick="excursionSICcalculation()" class="btn btn-primary">Save</button>
                </td>
         </tr>
         ...
         <tbody>
              ...
              <td>
               <div>
               <select required multiple="multiple" id="excursion_name_PVT"  name="excursion[]"  class="js-example-basic-multiple w-100 bg-white form-control form-control-lg">
                <!-- <select id="excursion_name" data-mdl-for="sample2" class="form-control"
                value=""  tabIndex="-1" name="excursion"> -->
                <!-- <option>Select Excursion</option> -->
                <?php 
           ...
           <td><button type="button" onclick="excursionPVTcalculation()" class="btn btn-primary">Save</button>
                </td>
         </tr>
            ...
            <thead>
             ...
             <tbody id="addrowss">
              ...
              <td>
               <div>
                <select data-mdl-for="sample2" class="form-control"
                value=""  tabIndex="-1" id="res_name" name="res_name">
           ...
           <td><input type="text" placeholder="0" id="adult_meal_cal" class="form-control check-adult" name="adult" >
           </td>
           <td><input type="text" placeholder="0" id="child_meal_cal" class="form-control check-child" name="child" <?php if($buildpackage->child == 0) echo "disabled";?> >
           </td>
        
           <td>      
            <a class="btn btn-info ml-0" onclick="addrowss()">
              add
            </a>
          </td>
         </tr>
...
<div class="last-btn mt-4 mb-4">
 ...
 <!-- <button id="view-proposal-btn" type="button" class="contact-next-btn mr-4">View Proposal</button>  -->
                      ...
                      removeHotel =function  removeHotel(data){
                         ...
                         if( allocated_days < totalNoOfDays ){
                          ...
                          var bnight = '<td><select class="form-control bnights" id="buildNoNights'+faqs_row+'"  name="buildNoNights'+faqs_row+'" required>';
                              ...
                              bnight += '</select></td>';
                          var room ='<td><select class="form-control get-hotel-room get_buildRoomType" name="buildRoomType'+faqs_row+'" id="buildRoomType'+faqs_row+'" required></select></td>';
                          template += '<tr id="faqs-row' + faqs_row + '">';
                          // template += '<td><input class="form-control" type="text" value="" name="buildHotelCity'+faqs_row+'" id="buildHotelCity'+faqs_row+'"></td>';
                          template += city;
                          template += '<td><input class="form-control" type="date" value="'+f.format("YYYY-MM-DD")+'" name="buildCheckIn'+faqs_row+'" id="buildCheckIn'+faqs_row+'" disabled></td>';
                          template += bnight;
                          template += ' <td> <div> <select data-mdl-for="sample2" class="form-control" value="" tabIndex="-1" id="Category'+faqs_row+'" name="Category'+faqs_row+'" onchange="get_hotel_name(this.id,'+faqs_row+');"> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> <option value="4">4</option> <option value="5">5</option> </select> </div> </td>';
                          // template += '<td><input class="form-control" type="text" placeholder="Room Type" name="buildRoomType'+faqs_row+'" id="buildRoomType'+faqs_row+'" required=""></td> ';
                        
                        
                          template += '<td><select class="form-control get_buildHotelName" id="buildHotelName'+faqs_row+'"  required="" name="buildHotelName'+faqs_row+'"  onchange="get_route_name(this.id,'+faqs_row+');" required><option>Select</option></select></td>';
                          template +=  room;

                          template +='<td><select class="form-control" id="buildBedType'+faqs_row+'"  required="" name="buildBedType'+faqs_row+'" required><option value = "Single">Single</option><option value="Double" >Double</option></select></td>';


                          template +='<td><input type="checkbox" id="extra_with_adult'+faqs_row+'" name="extra_check'+faqs_row+'" value="extra_with_adult" class="check-extra"><label for="html" style="margin-left: 5%;"> Extra Bed(Adult)</label><br><input type="checkbox" id="extra_with_child'+faqs_row+'" name="extra_check'+faqs_row+'" value="extra_with_child" class="check-extra"><label for="html" style="margin-left: 5%;"> Extra Bed(Child)</label><br><input type="checkbox" id="extra_without_bed'+faqs_row+'" name="extra_check'+faqs_row+'" value="extra_without_bed" class="check-extra"><label for="html" style="margin-left: 5%;"> Extra W/O Bed</label></td>';
