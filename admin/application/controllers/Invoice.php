...
class Invoice extends CI_Controller
{
    ...
    public function view_invoice()
    {
        ...
        foreach ($data['listInvoice'] as $key => $value) {
            if(!empty($value->query_id)) {
                ...
                $package_details = $this->db->where('queryId', $value->query_id)->get('querypackage')->row();
                if(!empty($company)){
                ...
                if(!empty($package_details)){
                    array_push($package_data,$package_details);
                } else {
                    array_push($package_data,null);
                }
            } else {
                    array_push($company_name,"N/A");
                    array_push($admin_names,"N/A");
    ...
    public function sendMailInvoice()
    {
        ...
        $subject =
        'DT/'. $admin_name .'/'. ($data['view']->adult + $data['view']->child + $data['view']->infant)  . ' Pax  
        ...
        <p>'.$data['printInvoice']->invoiceCategory.'</p>
        <p>Regards, DIAMOND TOURS LLC This Is auto generate Email Please Do not Reply on This Email (For Contact send email on&nbsp;<a href="mailto:info@diamondtoursdubai.com" rel="noreferrer noopener" target="_blank" title="mailto:info@diamondtoursdubai.com">info@diamondtoursdubai.com</a>)<br><br>Thanks &amp; Regards,<br><br>DIAMOND TOUR LLC<br> 704 BMI BUILDING, KHALID BIN AL WALEED ROAD, P.O.BOX 241685, BUR DUBAI, DUBAI-UNITED ARAB EMIRATES<br>E-Mail :&nbsp;<a href="mailto:Info@diamondtoursdubai.com" rel="noreferrer noopener" target="_blank" title="mailto:info@diamondtoursdubai.com">Info@diamondtoursdubai.com</a> ,&nbsp;<a href="http://www.diamondstoursdubai.com/" rel="noreferrer noopener" target="_blank" title="http://www.diamondstoursdubai.com/">www.diamondstoursdubai.com</a></p>
        <p><br></p>';
