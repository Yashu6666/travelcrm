                      ...
                      <div>
                        ...
                        <div class="row mt-4 mr-3 ml-3 mb-3">
                          <div class="col">
                            ...
                            <input type="checkbox" name="TransType" id="TrasportTypeSic" class="mr-3 ml-2 " value="Point to Point Transfer"><span class="transport-lable-ckeck">Point to Point Transfer</span><span class="checkmark"></span>
                        ...
                        <script>
                          $(document).ready(function() {
                            ...
                            $(".card-box").click(function(e) {
                              ...
                              var sub_total_adult = parseInt(total_price_internal) + parseInt(total_price_point);



                              $("#subtotal_adults").html(sub_total_adult);
                              $("#subtotal_childs").html(0);
        ...
        Any cancellation within 04 days will lead to 100% cancellation charge.
                                ...
                                <!-- <div class="accordion-item ">
                                  <h2 class="accordion-header" id="flush-headingTwo">
                                    <button class="accordion-button collapsed  width-refund" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseTwo">
                                      Refund Policy
                                    </button>
                                  </h2>
                                  <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                      <div class="form-floating">
                                        <textarea class="form-control" placeholder="Leave a comment here" id="buildPackageRefund" name="buildPackageRefund" style="height: 100px"></textarea>
                                      </div>
                                    </div>
                                  </div>
                                </div> -->
                          ...
                          <div class="last-btn mt-4 mb-4">
                            ...
                            <!-- <a id="view-proposal" type="button" class="contact-next-btn mr-4" href="?php echo base_url(); ?>/query/CreateProposalTransfer">View Proposal</a> -->
