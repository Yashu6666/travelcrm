              ...
              <div class="head3">
                ...
                <table class="items" border="1" cellspacing="0">
                  ...
                  <?php if (isset($details->per_pax_child) && $details->per_pax_child > 0) : ?>
                    <tr>
                      <td style="white-space: initial;"><span style="color: red;">AED <?php echo $details->per_pax_child ?></span> Per Child With Bed</td>
                    </tr>
                  <?php endif ?>
                  <?php if (isset($details->per_pax_infant) && $details->per_pax_infant > 0) : ?>
                    <tr>
                      <td style="white-space: initial;"><span style="color: red;">AED <?php echo $details->per_pax_infant ?></span> Per Child With Not Bed</td>
                    </tr>
                  <?php endif ?>
                </table>
                <br />
