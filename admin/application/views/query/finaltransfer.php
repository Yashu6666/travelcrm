            ...
            <div class="accordion-item border">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                    ...
                    <div class="accordion-body">
                        <div id="editor1">
                            <?php echo  $proposalDetails['buildPackageInclusions']  ?>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table border ">
                        ...
                        <tbody>
                            <tr>
                                <td><?php echo  "Transfer";//$buildpackage->type ?></td>
                    ...
                    <div class="row">
                        <div class="col">
                            <label class="input">
                                <input class="input__field  width-input" id="pro_sub" value="Transfer Proposal" type="text" placeholder=" "
                                    autocomplete="off" />
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        <button type="button" id="modal-transfer-submit" class="new_btn px-3" style="border: none";>Submit</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    console.log("🚀 ~ file: finaltransfer.php ~ line 824 ~ btn", btn)
    ...
    btn.addEventListener("click", () => {
        ...
        console.log("🚀 ~ file: finaltransfer.php ~ line 848 ~ btn.addEventListener ~ data_arr", data_arr)
