...
<body>
    ...
    <div class="container">
        ...
        <div class="" style="float:right;margin-top: 1%">
            <!-- <a type="button" onclick="history.back();"  class="new_btn px-3" style="border: none ">Edit Package</a> -->
            ...
            <div class="accordion accordion-flush mt-2">
                <div class="accordion-item border">
                    ...
                    <?php if (isset($proposalDetails['in_transfer_pickup'])  && !empty($proposalDetails['in_transfer_pickup'])) : ?>
                        <?php foreach ($proposalDetails['in_transfer_pickup'] as $key => $val) : ?>
                            <?php if ($val != 'Pickup') : ?>
                                <li><?php echo $proposalDetails['internal_transfer_route'][$key] ?></li>
                            <?php endif ?>
                        <?php endforeach ?>
                    <?php endif ?>
                    ...
                    <?php if (isset($proposalDetails['pp_transfer_pickup'])  && !empty($proposalDetails['pp_transfer_pickup'])) : ?>
                        <?php foreach ($proposalDetails['pp_transfer_pickup'] as $key => $val) : ?>
                            <?php if ($val != 'Pickup') : ?>
                                <li><?php echo $proposalDetails['return_transfer_pickup'][$key] ?></li>
                            <?php endif ?>
                        <?php endforeach ?>
                    <?php endif ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table border ">
                        ...
                        <tbody>
                            <tr>
                                <td><?php echo  "Transfer"; //$buildpackage->type 
                                    ?></td>
                    ...
                    <div class="row">
                        <div class="col">
                            <label class="input">
                                ...
                                <input class="input__field  width-input" id="pro_sub" type="text" value="<?php echo $buildpackage->queryId ?> - Diamond Tours LLC Dubai / Pax:<?php echo ($buildpackage->adult + $buildpackage->child + $buildpackage->infant) ?>/ 
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        <button type="button" id="modal-transfer-submit" class="new_btn px-3" style="border: none" ;>Send</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        const btn = document.getElementById("modal-transfer-submit");
