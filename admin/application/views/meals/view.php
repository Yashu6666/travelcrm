								...
								<div class="card-body ">
									<div class="row p-b-20">
										<div class="col-md-6 col-sm-6 col-6">
											<div class="btn-group">
												<a href="<?php echo site_url();?>meals/add_meals" id="addRow" class="new_btn px-3">
											...
											<tbody>
												...
												<tr class="odd gradeX">
													...
													<td class="">
														...
														<a class="btn btn-tbl-delete btn-xs" href="<?php echo site_url();?>meals/delete_meals/<?php echo $view[$i]->id;?>" onclick="return confirm('Are you sure to Delete..?')">
