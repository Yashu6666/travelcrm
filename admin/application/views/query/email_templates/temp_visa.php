    ...
    <div class="card" style="margin-left:10px;">
        <div class="card1">
            ...
            <table class="table">
                ...
                <tr>
                    <th>Type of Visa</th>
                    <td colspan="3"><?php echo preg_replace('/\_/', ' ', $details->visa_category_drop_down);?></td>
                </tr>
                <tr>
                    <th>Entry Type</th>
                ...
                <tr>
                    ...
                    <td colspan="3">Holidays/ Transit</td>
                </tr>
        ...
        <div class="card4">
            ...
            <p><span style='font-size:15px;'>&#9673;&nbsp;</span>Dubai Single Entry Tourist Visa with Covid-19 Inbound Insurance</p>
