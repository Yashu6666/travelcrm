                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <input class="form-control child_per_room_wo_bed" type="hidden" readonly value="<?php echo $no_child_room_wo_new[$i - 1]; ?>" name="child_per_room_wo_bed[]" id="child_per_room_wo_bed">
                                    </td>
                                    <td colspan="2">
