                    ...
                    <script>
                      $(document).ready(function() {
                        ...
                        $(".card-box").click(function(e) {
                          ...
                          $("#totalprice_adult").val(c_type == 'USD' ? Math.ceil(total_adult / usd_aed).toFixed(2) : total_adult);
                          $("#totalprice_childs").val(c_type == 'USD' ? Math.ceil(total_child / usd_aed).toFixed(2) : total_child);
