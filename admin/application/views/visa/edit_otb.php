   ...
   <div class="page-content">
    <div class="page-bar">
     <div class="page-title-breadcrumb">
      <div class=" pull-left">
       <div class="page-title">Edit OTB</div>
      </div>
      <ol class="breadcrumb page-breadcrumb pull-right">
       ...
       <li>&nbsp;<a class="parent-item" href="#">Inventory</a>&nbsp;<i
        ...
        <li>&nbsp;<a class="parent-item" href="<?php echo site_url();?>visa/view_visa">OTB</a>&nbsp;<i
         class="fa fa-angle-right"></i></li>

         <li class="active">Edit OTB</li>
        </ol>
       </div>
      </div>
      <div class="row">
          ...
          <table id="faqs" class="table table-hover">
           ...
           <tbody>
            ...
            <tbody>
             ...
             <tr id="">
           <td>
           <input type="text" readonly placeholder="0" class="form-control" name="visa_category" value="OTB">
            </td>
