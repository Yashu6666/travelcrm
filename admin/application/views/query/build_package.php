                        ...
                        <div class="row mt-4 mr-3 ml-3 mb-3" <table class="table table-bordered">
                          ...
                          <table class="table table-bordered card-box" style="font-size:16px;">
                            ...
                            <tr align="center">
                              ...
                              <td> <input type="text" disabled="disabled" class="text-center" id="subtotal_cnb" name="subtotal_cnb" value="0"></td>
                              <td> <input type="text" disabled="disabled" class="text-center" id="subtotal_infants" name="subtotal_infants" value="0"></td>
                            </tr>
                            <tr align="center">
                              ...
                              <td> <input type="text" disabled="disabled" class="text-center" name="totalprice_cnb" id="totalprice_cnb" value="0"></td>
                              <td> <input type="text" disabled="disabled" class="text-center" name="totalprice_infants" id="totalprice_infants" value="0"></td>
                            </tr>
                            <tr align="center">
                              <td><b>Per PAX</b></td>
                              ...
                              <td> <input type="text" disabled="disabled" class="text-center" name="perpax_cnb" id="perpax_cnb" value="0"></td>
                              <td> <input type="text" disabled="disabled" class="text-center" name="perpax_infants" id="perpax_infants" value="0"></td>
                            </tr>
                          </table>
