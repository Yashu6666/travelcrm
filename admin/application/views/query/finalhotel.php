        ...
        <div class="accordion accordion-flush mt-5">
            <div class="accordion-item border">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"
                    ...
                    <div class="accordion-body">
                        <div id="editor1"><?php echo  $proposalDetails['inclusions']  ?></div>
                    </div>
                </div>
            </div>
            <div class="accordion-item mt-3 border">
                ...
                <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo"
                    data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        <div id="editor2"><?php echo  $proposalDetails['exclusions']  ?></div>
                    </div>
                </div>
            </div>
            <!-- <div class="accordion-item  mt-3 border">
                ...
                <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree"
                    data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        <div id="editor3"><?php //echo $proposalDetails['refund']  ?></div>
                    </div>
                </div>
            </div> -->
        </div>
            ...
            <div class="">
                <div class="">
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="button" class="new_btn px-3  ">Send Message</button>
                    </div>
                </div>
            </div>
        </div> -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        <button type="button" id="modal-submit" class="new_btn px-3">Submit</button>
                    </div>
                </div>
            </div>
        </div>
