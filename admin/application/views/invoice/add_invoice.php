...
" class="input__field" type="text"
                                                                ...
                                                                autocomplete="off" value="<?php echo $query_id;?>"/>
                                ...
                                <input type="hidden" id="com_invoiceDesc" name="com_invoiceDesc" value=""/>  
                                ...
                                <div class="card-body ">
                                                    ...
                                                    <td>
                                                        <div class="mb-3">
                                                            <input type="text" class="form-control invoiceDesc" id="invoiceDesc"
                                                                ...
                                                                value="<?php echo isset($desc) ? $desc : "" ?>" autocomplete="off">
                                                    ...
                                                    <td>
                                                        <div class="mb-3">
                                                            <input type="number" id="invoicePax" class="form-control invoicePax"  name="invoicePax[]"
                                                                aria-describedby="emailHelp" value=<?php echo isset($pax) ? $pax : "" ?> autocomplete="off" >
                                        ...
                                        <input type="hidden" name="finalVAT" id="finalVAT" class="form-control"
                                            value="0" aria-describedby="passwordHelpInline" autocomplete="off" readonly="">
