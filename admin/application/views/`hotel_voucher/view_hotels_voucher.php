								...
								<div class="card-body ">
									<div class="row p-b-20">
										<div class="col-md-6 col-sm-6 col-6">
											<div class="btn-group">
												<a href="<?php //echo site_url();?>hotel/add_hotel" id="addRow-btn" class="btn btn-info">
												Hotel Voucher <i class="fa fa-plus"></i>
												</a>
											</div>
										</div>
										<div class="col-md-6 col-sm-6 col-6">
										...
										<table class="table table-hover table-checkable order-column full-width"
											...
											<tbody>
												...
												<td class="center">1</td>
													<td class="center">8700</td>
													<td class="center">taj</td>
													<td class="center">19-07-2022</td>
													<td class="center">09:00AM</td>
													<td class="center">11:00AM</td>
												...
												<td class="center">2</td>
													<td class="center">8700</td>
													<td class="center">Royal hotel</td>
													<td class="center">18-07-2022</td>
