          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card card-box">
                ...
                <div class="card-body ">
                  <form class="form-horizontal tour-form row" method="POST" action="<?php echo site_url();?>excursion/updateExcursionDetails/<?php echo $edit->id;?>" enctype="multipart/form-data"
  >
                    <div class="col-md-8">
                        ...
                        <div class="tab-pane show active" role="tabpanel" id="materialTabBarJsDemo"
                          ...
                          <mwc-tab-bar class="nav nav-tabs" role="tablist">
                            <mwc-tab id="GENERAL-tab" label="GENERAL" data-bs-toggle="tab" data-bs-target="#GENERAL"
                              role="tab" aria-controls="GENERAL" aria-selected="true" dir="" class="active" active="">
                            </mwc-tab>
                                        ...
                                        <tr>
                                          <td>
                                            <input type="text" class="form-control Places pac-target-input"
                                              ...
                                              name="tourmapaddress" value="<?php echo $edit->tourmapaddress;?>" placeholder="Enter Address"
                                              autocomplete="off">
                                          </td>
                                        </tr>
...
<!-- 
                          ...
                          <div class="row form-group mb-3">
                            ...
                            <div class="col-md-8">
                              <input  type="text"  value="<?php echo $edit->pax;?>"  class="form-control" name="pax">
                            </div>
                          </div> 
                         ...
                         <div class="row form-group mb-3">
                            ...
                            <div class="col-md-8">
                              <input  type="time" class="form-control" name="operating_from"value="<?php echo $edit->operating_from;?>" >
                            </div>
                          </div>
                          <div class="row form-group mb-3">
                            <label class="col-md-4 control-label text-left"> <b>To</b></label>
                            <div class="col-md-8">
                              <input  type="time" class="form-control" name="operating_to" value="<?php echo $edit->operating_to;?>" >
                            </div>
                          </div>
...
<script>
    ...
    $(function () {
      var checkAll = $('input.all_ex');

      var checkboxes = $('input.checkboxcls_ex');

      $('.tab-pane_ex input').iCheck({
        checkboxClass: "icheckbox_square-grey_ex",
      });
