        ...
        <div class="head">
            ...
            <div class="head3">
                ...
                <table class="items" border="1" cellspacing="0">
                    ...
                    <tr>
                        <th>Meal Type</th>
                        <td colspan="3"><?php echo isset($details->res_type) ? implode(",", $details->Meal_Type) : "" ?></td>
                    </tr>
                    
                    <tr>
                        <th>Meal</th>
                        <td colspan="3"><?php echo isset($details->res_type) ? implode(",", $details->Meal) : "" ?></td>
                    </tr>

                    <tr>
                        <th>Restaurant Name</th>
                        <td colspan="3"><?php echo isset($details->res_name) ? implode(",", $details->res_name) : "" ?></td>
                    </tr>
                    <tr>
            ...
            <div class="head9">
                <span><b><u>GENERAL TERMS AND CONDITIONS :</u></b></span> <br></br>
                <p>
