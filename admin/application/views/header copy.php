...
<body
	...
	<div class="page-wrapper">
		<!-- start header -->
		<div class="page-header navbar navbar-fixed-top" style="background-color:#ef4c4c !important;">
			<div class="page-header-inner ">
				<!-- logo start -->
				<div class="page-logo">
					<a href="index.html">
						<span class="logo-default"><img src="<?php echo base_url();?>public/image/logo.png" style="margin-left: -23px !important;margin-top: -8px !important;background:white !important;"/></span> </a>
				</div>
				<!-- logo end -->
