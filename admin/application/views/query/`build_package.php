<link href="https://cdnjs.cloudflare.com/ajax/libs/mdb-ui-kit/3.3.0/mdb.min.css"
  ...
  <div class="page-content-wrapper" id="FullPage">
   ...
   <div class="row mt-5">
               ...
               <td>
                ...
                <td>
                  <!-- <input class="form-control" type="number" value="1" max="<?php //echo $buildpackage->night?>" name="buildNoNights" id="buildNoNights"> -->
                   <select class="form-control bnights get_no_nights" id="buildNoNights"  name="buildNoNights[]" required>
           ...
           <td>
              ...
              <td>
                ...
                <!-- <select class="form-control" id="buildExtraBedType"  required="" name="buildExtraBedType" required> -->
                  ...
                  <input type="checkbox" id="extra_with_child" name="extra_check[]" value="extra_with_child" class="check-extra extra_with_child"><label for="html" style="margin-left: 5%;">  Extra Bed(Child)</label><br/>  
                  <input type="checkbox" id="extra_without_bed" name="extra_check[]" value="extra_without_bed" class="check-extra extra_without_bed"><label for="html" style="margin-left: 5%;">  Extra W/O Bed</label>
           ...
           <td><button type="button" onclick="excursionPVTcalculation()" class="btn btn-primary">Save</button>
            ...
            <thead>
             ...
             <tbody id="addrowss">
              ...
              <td>
               <div>
                <select data-mdl-for="sample2" class="form-control rest_name"
        ...
        <script src="<?php echo base_url();?>public/js/validate.js"></script>
                    ...
                    $("#selecttraveler").hide();
                        ...
                        function addrowss(){
                          ...
                          adds += '<td> <div> <select data-mdl-for="sample2" class="form-control rest_name" value="" tabIndex="-1" id="res_name'+faqs_row2 + '" name="res_name[]"> <option value="Standard">Standard</option> <option value="Premium">Premium</option> </select> </div> </td>';
                          adds += '<td> <div> <select data-mdl-for="sample2" class="form-control meal" value="" tabIndex="-1" id="meal_cal'+faqs_row2 + '" name="Meal[]"> <option value="Lunch">Lunch</option> <option value="Dinner">Dinner</option> </select> </div> </td>';
     ...
     <div class="accordion" id="accordionPanelsStayOpenExample">
      ...
      <div class="accordion-body">
       <div class="form-floating">
        ...
        id="buildPackageInclusions" name="buildPackageInclusions" ></textarea>
    ...
    <div class="accordion-body">
     <div class="form-floating">
      <textarea class="form-control" placeholder="Leave a comment here"
      id="buildPackageExclusions" name="buildPackageExclusions" ></textarea>
      <!-- <label for="floatingTextarea2">Comments</label> -->
     </div>
    </div>
   </div>
  ...
  <div class="accordion-body">
   <div class="form-floating">
    <textarea class="form-control" placeholder="Leave a comment here"
    id="buildPackageConditions" name="buildPackageConditions" >
...
<div class="accordion mt-3" id="accordionExample">
 ...
 <div class="accordion-body">
  <div class="form-floating">
   <textarea class="form-control" placeholder="Leave a comment here"
   id="buildPackageCancellations" name="buildPackageCancellations" >
...
<div class="accordion-body">
 <div class="form-floating">
  <textarea class="form-control" placeholder="Leave a comment here"
  id="buildPackageRefund" name="buildPackageRefund" ></textarea>
 </div>
</div>
</div>
</div> -->
                   ...
                   var extra_with_adult = [];
                    ...
                    // console.log(data);
                      ...
                      $.ajax({ 
                          ...
                          data : {data : data, total_rows : total_rows,'pax_adult':pax_adult,'pax_child':pax_child},
                          cache: false,
                          dataType: "json",
                          success: function(response)
                          {
                      ...
                      removeHotel =function  removeHotel(data){
                        ...
                        function addrows(){
                         ...
                         if( allocated_days < totalNoOfDays ){
                          ...
                          var bnight = '<td><select class="form-control bnights get_no_nights" id="buildNoNights'+faqs_row+'"  name="buildNoNight[]">';
                                          for (let i = 1; i <= (totalNoOfDays-allocated_days); i++) {
                                            bnight += '<option>'+i+'</option>';
                                          }
                              bnight += '</select></td>';
                          ...
                          template +='<td><select class="form-control get_bed_type" id="buildBedType'+faqs_row+'"  required="" name="buildBedType[]" required><option value = "Single">Single</option><option value="Double" >Double</option></select></td>';


                          template +='<td><input type="checkbox" id="extra_with_adult'+faqs_row+'" name="extra_check[]" value="extra_with_adult" class="check-extra extra_with_adult"><label for="html" style="margin-left: 5%;"> Extra Bed(Adult)</label><br><input type="checkbox" id="extra_with_child'+faqs_row+'" name="extra_check[]" value="extra_with_child" class="check-extra extra_with_child" ><label for="html" style="margin-left: 5%;"> Extra Bed(Child)</label><br><input type="checkbox" id="extra_without_bed'+faqs_row+'" name="extra_check[]" value="extra_without_bed" class="check-extra extra_without_bed"><label for="html" style="margin-left: 5%;"> Extra W/O Bed</label></td>';
